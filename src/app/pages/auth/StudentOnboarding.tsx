...
const steps = [
  { icon: Users, label: "Join a class", color: "#272757" },
  { icon: BookOpen, label: "Take your first quiz", color: "#10B981" },
];
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4">
      <div className="w-full max-w-xl">
        <div className="flex justify-center mb-8">
          <Logo variant="horizontal" size="md" color="#272757" />
        </div>
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          {steps.map((s, i) => (
            <div key={i} className="flex items-center gap-2">
              ...
              {i < steps.length - 1 && (
                <div className={`w-16 h-1 rounded-full ${i < step ? "bg-[#10B981]" : "bg-gray-200"}`} />
              )}
            </div>
          ))}
        </div>
        ...
        <Card className="bg-white rounded-xl border border-gray-100 shadow-sm p-8">
              ...
              {!joined ? (
                <div className="space-y-3">
                  <Input
                    ...
                    className={`w-full rounded-xl border-2 px-4 py-4 font-mono text-center text-xl tracking-widest ${
                      codeError ? "border-red-400" : "border-gray-200 focus:border-[#272757]"
                    }`}
                ...
                <div className="bg-[#10B981]/10 border-2 border-[#10B981]/30 rounded-2xl p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Joined class with code <span className="font-mono font-bold text-[#272757]">{classCode}</span>
                  </p>
                </div>
              )}
            </div>
          ...
          {step === 1 && (
            <div className="text-center">
              ...
              <div className="bg-[#272757]/5 rounded-2xl p-6 text-left space-y-3 mb-6">
          ...
          <Button
            onClick={handleNext}
            className="w-full mt-8 bg-[#272757] hover:bg-[#29B5E8] text-white py-6 rounded-2xl text-lg font-semibold shadow-lg flex items-center justify-center gap-2"
          >
