...
const TOUR_KEY = "qm_teacher_tour_done";

const steps = [
  {
    title: "Create your first class",
    body: "Click here to create a class and add your students.",
    target: "My Classes",
    position: { top: "140px", left: "240px" },
  },
  {
    title: "Generate your first quiz",
    body: "Use AI to generate a quiz in seconds.",
    target: "My Quizzes",
    position: { top: "190px", left: "240px" },
  },
  {
    title: "Share with students",
    body: "Give students the class code or quiz link to get started.",
    target: "Share Quiz",
    position: { top: "50%", left: "50%" },
  },
];

export function TeacherOnboardingTour({ children }: { children: React.ReactNode }) {
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#8686AC]">Step {step + 1} of 3</span>
